...
(function() {
	...
	f.extend = function(a, b) {
		var c = typeof arguments[arguments.length - 1] === 'boolean' ? arguments[arguments.length - 1]
				: false;
		var d = b, snk = a;
		...
		addListener : function(a, b, c) {
			...
			if (typeof a !== 'string') {
				f.raiseError(this, '03091549', 'param',
						'::EventTarget.addListener', new Error(
		...
		removeListener : function(a, b, c) {
			...
			if (typeof a !== 'string') {
				f.raiseError(this, '03091559', 'param',
						'::EventTarget.removeListener', new Error(
								'Unspecified Event Type'));
				return
			}
			if (typeof b !== 'function') {
		...
		triggerEvent : function(a, b, c) {
			if (typeof a !== 'string') {
				f.raiseError(this, '03091602', 'param',
						'::EventTarget.dispatchEvent', new Error(
								'Invalid Event Type'));
				return undefined
			}
			a = a.toLowerCase();
						...
						debugMode : {
							...
							enabled : function(a, b, c) {
								...
								if (typeof a === 'boolean' && a !== m.enabled) {
									i.core[(m.enabled = a) ? 'addEventListener'
											: 'removeEventListener']('*',
											m.outputHandler)
								}
								if (typeof b === 'function') {
							...
							_enableFirebugLite : function(a) {
								if (window.console && window.console.firebug) {
									i.core.debugMode.enabled(console.log,
											'verbose');
									return
								}
								var b = document.createElement('script');
								b.type = 'text/javascript';
								b.src = typeof a === 'string' ? a
...
(function() {
	...
	var g = function() {
		f.raiseError(this, '25081845', 'run', '::RendererManager', new Error(
				'No active renderer'));
		return
	};
	var h = {
		...
		if (a.success === false) {
			f
					.raiseError(
							...
							'::RendererManager',
							new Error(
									'There was an error rendering the chart. ' + 'Enable FusionCharts JS debugMode for more information.'))
		}
			...
			.extend(
					{
						render : function(a) {
							...
							if (k(this.id, a)) {
								f.raiseError(this, '05102109', 'run',
										'.render()', new Error(
						...
						configure : function(b, c) {
							f.renderer.config(this, (typeof b === 'object') ? b
									: (function() {
										var a = {};
										a[b] = c;
										return a
...
(function() {
	...
	g.addDataHandler = function(b, c) {
		if (typeof b !== 'string' || h[b.toLowerCase()] !== undefined) {
			g.raiseError(g.core, '03091606', 'param',
					'::DataManager.addDataHandler', new Error(
							'Invalid Data Handler Name'));
			return
		}
			...
			.extend(
					{
						setChartDataUrl : function(c, d, e) {
							if (d === undefined || d === null
								...
								g.raiseError(g.core, '03091609', 'param',
										'.setChartDataUrl', new Error(
												'Invalid Data Format'));
								return
							}
						...
						setChartData : function(a, b, c) {
							if (b === undefined || b === null
								...
								g.raiseError(g.core, '03091610', 'param',
										'.setChartData', new Error(
												'Invalid Data Format'))
							}
							...
							if (typeof e === 'undefined') {
								g.raiseError(g.core, '03091611', 'param',
										'.setChartData', new Error(
							...
							if (cancelDUFlag === true) {
								g.raiseEvent('DataUpdateCancelled', eventArgs,
										this);
								return
							}
							...
							if (a === undefined
								...
								g
										.raiseError(
												...
												'~getChartData()',
												new Error(
														'Unrecognized data-format specified in "format"'));
								return undefined
							}
							parseResult = (typeof cache[this.id][a] === 'object') ? cache[this.id][a]
									: cache[this.id][a] = c.decode(
											dataStore[this.id], this);
							return Boolean(b) === true ? parseResult
									: parseResult.data
						}
					}, true);
	g
							...
							if (!b
								...
								g
										.raiseError(
												...
												'transcodeData()',
												new Error(
														'Unrecognized data-format specified during transcoding.'));
								return undefined
							}
							var e = h[b].encode(a, this), l2 = h[c].decode(
									e.data, this);
	...
	g.core.addEventListener('Loaded', function(e) {
		var a = e.sender;
		if (a.__state.updatePending !== undefined) {
...
(function() {
	...
	window.getChartFromId = function(a) {
		return f.core.items[a] instanceof f.core ? f.core.items[a].ref
			...
			.extend(
					{
						setChartAttribute : function(a) {
							...
							var i = 0, json = this
									.getChartData(FusionChartsDataFormats.JSON), prop, attList = json.chart
									|| json.graph || {};
							for (prop in a) {
								i += 1;
							...
							if (i > 0) {
								...
								this.setChartData(json,
										FusionChartsDataFormats.JSON)
							}
						},
						getChartAttribute : function(a) {
							var b = (b = this
									.getChartData(FusionChartsDataFormats.JSON)).chart
									|| b.graph;
							...
							if (typeof a === 'string') {
								...
								d.raiseError(this, '25081429', 'param',
										'~getChartAttribute()',
...
(function() {
	...
	var z = y.swfobject = function() {
		...
		function C(s) {
			var a = /[\\\"<>\.;]/;
			var b = a.exec(s) != null;
			return b && typeof encodeURIComponent != w ? encodeURIComponent(s)
					: s
		}
		var x = function() {
			if (ua.ie && ua.win) {
			...
			return !((b = y.core(a)) instanceof y.core && b.ref && (parent = b.ref.parentNode)) ? {}
					: {
						width : parent.offsetWidth
								* (c.test(b.width) ? parseInt(b.width, 10) / 100
										: 1),
						height : parent.offsetHeight
								* (c.test(b.height) ? parseInt(b.height, 10) / 100
										: 1)
					}
		}
	}());
		...
		if (typeof b === 'object') {
			...
			if (c.ref && typeof c.ref.dataInvokedOnSWF === 'function'
				...
				if (b.dataURL !== undefined) {
					...
					c.flashVars.dataXML = window.unescape(b.dataXML)
				}
			}
			return true
		}
			...
			if (!this.src) {
				y
						.raiseError(
								...
								'Could not find a valid "src" attribute. swfUrl or chart ' + 'type missing.')
			}
		...
		update : function(a) {
			...
			if (a.error === undefined) {
				...
				if (this.isActive() && typeof b.showChartMessage === 'function') {
					...
					this.flashVars.dataXML = '<Invalid' + a.format
							.toUpperCase() + '>';
					delete this.flashVars.dataURL;
					delete this.flashVars.animation
				}
	...
	E.prototype = {
		getSWFHTML : function() {
			var a = document.createElement('span'), inElm = document
					.createElement('span'), tempId = 'RnVzaW9uQ2hhcnRz' + (new Date())
					.getTime();
			a.appendChild(inElm);
		...
		setTransparent : function(a) {
			...
			this.params.wMode = a === null ? 'window'
					: (a === true ? 'transparent' : 'opaque')
		},
	...
	FCC.init = function() {
			...
			method : {
				getExternalInterfaceMethods : function(a) {
					return FCFCC.commonMethodCSV
							+ (FCFCC.methodCSV[a || this.chartType()] || '')
				},
				print : function() {
					var a = this.id;
				...
				font : function(c, d, e) {
					var f, x, map = {
						...
						underline : function(a, b) {
							b['text-decoration'] = a == '1' ? 'underline'
									: 'normal'
						}
					};
					switch (d) {
		...
		function drawOverlayButton(b) {
			if (b.show) {
				...
				c.style.border = '1px solid #' + (b.borderColor ? b.borderColor
						: "7f8975");
				c.style.backgroundColor = '#' + (b.bgColor ? b.bgColor
						: "edefec");
				...
				c.style.fontWeight = parseInt(b.bold, 10) === 0 ? 'normal'
						: 'bold';
		...
		var v = function(a, b, d) {
			...
			if (e.formatnumber == 1) {
				...
				result = (splitVal === undefined) || (decimalVal === 0) ? formatedNum
			...
			if (e.forcedecimals == 1) {
				...
				if (decimalLength > e.decimals) {
					if (e.decimals == 1 && decimalVal[0] >= 5) {
						...
						last = decimalVal[e.decimals] >= 5 ? (parseInt(
								decimalVal[e.decimals - 1], 10) + 1)
			...
			if (e.formatnumberscale == 1) {
				result += (i === -1) ? e.defaultnumberscale
						: numberScaleUnit[i]
			}
		...
		var C = function(a, b) {
			...
			if ((a === 2 && this.link) || (a === 1 && this.options.chart.link)) {
				...
				case 'p':
					...
					break;
				case 'newchart':
					var d = arr[1].toLowerCase().search('url') != -1 ? 'URL'
		...
		var H = function(a, b) {
			...
			var c = u(b.src);
			var d = FCFCC.method.getExternalInterfaceMethods(c).split(','), i;
			for (i = 0; i < d.length; i += 1) {
				if (typeof a[d[i]] === 'function') {
					continue
				}
				if (FCFCC.method[d[i]] === undefined) {
					a[d[i]] = noEffect
				} else {
					a[d[i]] = FCFCC.method[d[i]]
				}
			}
		};
							...
							formatter : function() {
								...
								if (this.series.type == 'pie') {
									x = (a.chart.showlabels === '0'
											...
											: this.point.FCname);
									y = showvalue === '1' ? (Math
											.round(this.percentage * 100) / 100)
											+ (a.chart.showpercentagevalues === '1' ? '%'
													: '')
											: '';
									return parseStr(x
											+ (x !== '' && y !== '' ? a.chart.tooltipsepchar
													: '') + y)
								} else if (showvalue === '1') {
				...
				for (y = 0; y < loopMax; y += 1) {
					if (typeof b[y] === 'object') {
						if (!b[y].vline) {
							...
							a.data
									.push( {
										y : tempY || 0,
										x : (isAbs ? Math
												.abs(parseFloat(b[y].x))
												: parseFloat(b[y].x)) || undefined,
										z : (isAbs ? Math
												.abs(parseFloat(b[y].z))
												: parseFloat(b[y].z)) || undefined,
										color : (c < 2 || b[y].color || b[y].alpha) ? convertColor(
												b[y].color || (c < 2 && g(y)),
												b[y].alpha, a.color)
												: undefined,
										...
										marker : (seriesType === 'areaspline'
											...
											enabled : b[y].drawanchors ? (b[y].drawanchors == '1' ? true
													: false)
													: undefined,
											radius : b[y].anchorradius ? b[y].anchorradius
													: undefined,
											symbol : w(parseInt(
													b[y].anchorsides, 10)),
											fillColor : b[y].anchorbgcolor ? convertColor(
													b[y].anchorbgcolor || 'FFFFFF',
													b[y].anchorbgalpha || 100)
													: undefined,
											lineColor : b[y].anchorbordercolor ? convertColor(
													b[y].anchorbordercolor || '767575',
													b[y].anchoralpha || 100)
													: undefined,
											lineWidth : b[y].anchorborderthickness ? b[y].anchorborderthickness
													: undefined
										}
												: (c === 7.5 ? {
													radius : b[y].z ? Math
						...
						for (x = 0; x < value.length; x += 1) {
							tempY = isAbs ? Math.abs(parseFloat(value[x]))
									: parseFloat(value[x]);
							if (tempY < 0) {
								f.FCconf.negative = true
							}
					...
					if (b.dataset[x].dataset
						...
						for (y = 0; y < b.dataset[x].dataset.length; y += 1) {
							newSeries = {
								...
								yAxis : b.dataset[x].dataset[y].parentyaxis == 'S' ? 1
										: undefined,
								...
								for (z = 0; z < max_cat; z += 1) {
									...
									newSeries.data
											.push( {
												...
												id : h,
												color : b.dataset[x].dataset[y].data[z].color ? convertColor(
														b.dataset[x].dataset[y].data[z].color
																|| i(count_set),
														b.dataset[x].dataset[y].data[z].alpha || 100)
														: undefined
											})
								}
							}
		...
		function addData(c, d, e, f, g, h, i) {
			...
			case 6.5:
				...
				case 3:
					...
					break;
				case 5.5:
					f.plotOptions.column.stacking = c.chart.stack100percent == '1' ? 'percent'
							: 'normal'
				}
				addCategory(c, d, f);
				if (d !== 6) {
					if (c.dataset) {
						...
						for (x = 0; x < c.dataset.length; x += 1) {
							z = createSeries(
									...
									c.dataset[x].renderas ? FCFCC.combi[c.dataset[x].renderas
											.toLowerCase()]
											: ((c.dataset[x].parentyaxis == 'S' && (d == 5 || d == 5.5)) ? 'line'
													: undefined),
									c.dataset[x].seriesname,
									c.dataset[x].parentyaxis == 'S',
									c.dataset[x].showvalues,
									c.dataset[x].plotbordercolor ? convertColor(
											c.dataset[x].plotbordercolor,
											c.dataset[x].plotborderalpha || 95)
											: undefined,
									parseInt(c.dataset[x].plotborderthickness
											|| c.dataset[x].linethickness, 10) || undefined);
							var j = z.type || f.chart.defaultSeriesType;
							z.marker = (j === 'area' || j === 'line'
									|| j === 'spline' || j === 'areaspline') ? {
								enabled : c.dataset[x].drawanchors ? (c.dataset[x].drawanchors == '1' ? true
										: false)
										: undefined,
								radius : c.dataset[x].anchorradius ? c.dataset[x].anchorradius
										: undefined,
								symbol : w(parseInt(c.dataset[x].anchorsides,
										10)),
								fillColor : c.dataset[x].anchorbgcolor ? convertColor(
										c.dataset[x].anchorbgcolor || 'FFFFFF',
										c.dataset[x].anchorbgalpha || 100)
										: undefined,
								lineColor : c.dataset[x].anchorbordercolor ? convertColor(
										c.dataset[x].anchorbordercolor || '767575',
										c.dataset[x].anchoralpha || 100)
										: undefined,
								lineWidth : c.dataset[x].anchorborderthickness ? c.dataset[x].anchorborderthickness
										: undefined
							}
									: null;
							count_set += 1;
				...
				if (c.dataset) {
					...
					for (x = 0; x < c.dataset.length; x += 1) {
						z = createSeries(
								...
								c.dataset[x].seriesname,
								c.dataset[x].parentyaxis == 'S',
								c.dataset[x].showvalues, undefined, undefined);
						z.marker = {
		...
		function ModyfyLegend(b, c) {
			...
			if (c.chart.showlegend == '0') {
				...
				b.legend.backgroundColor = convertColor(
						c.chart.legendbgcolor || '#ffffff',
						c.chart.legendbgalpha || 100);
				b.legend.borderColor = convertColor(
						c.chart.legendbordercolor || '#545454',
						c.chart.legendborderalpha || 100);
		...
		function convertMarimeko(a, b, c, d, e) {
			...
			for (y = 0; y < a.series.length; y += 1) {
				...
				for (z = 0; z < a.series[y].data.length; z += 1) {
					...
					temp2 = setPersent ? parseFloat(e[0].category[z].widthpercent) / 100
							: (arr[z] / total);
					totalpercent += temp2;
		...
		function covertToFCC(a, b, c, d, e, f) {
			...
			g.plotOptions.series.animation = c.chart.animation === '0' ? false
					: true;
			...
			g.plotOptions.line.marker.lineColor = g.plotOptions.areaspline.marker.lineColor = g.plotOptions.spline.marker.lineColor = convertColor(
					c.chart.anchorbordercolor || '767575',
					c.chart.anchoralpha || 100);
			g.plotOptions.area.marker.lineColor = convertColor(
					c.chart.anchorbordercolor || '767575',
					c.chart.anchoralpha || 0);
			...
			g.plotOptions.area.color = g.plotOptions.areaspline.color = convertColor(
					c.chart.plotfillcolor || '767575',
					c.chart.plotfillalpha || 90);
			...
			g.plotOptions.area.lineWidth = g.plotOptions.areaspline.lineWidth = parseInt(
					c.chart.plotborderthickness, 10) || 1;
			g.yAxis[0].alternateGridColor = convertColor(
					c.chart.alternatehgridcolor || 'EEEEEE',
					c.chart.alternatehgridalpha || 50);
			g.yAxis[0].gridLineColor = convertColor(
					c.chart.divlinecolor || '717170',
					c.chart.divlinealpha || 40);
			g.yAxis[0].gridLineWidth = c.chart.divlinethickness ? c.chart.divlinethickness
					: 1;
			if (c.chart.caption) {
			...
			g.tooltip.backgroundColor = convertColor(
					c.chart.tooltipbgcolor || 'FFFFFF',
					c.chart.tooltipbgalpha || 100);
			g.tooltip.borderColor = convertColor(
					c.chart.tooltipbordercolor || '545454',
					c.chart.tooltipborderalpha || 100);
						...
						for (z = 0; z < c.trendlines[x].line.length; z += 1) {
							if (c.trendlines[x].line[z].istrendzone == '1') {
								g.yAxis[0].plotBands
										.push( {
											color : convertColor(
													c.trendlines[x].line[z].color || '333333',
													c.trendlines[x].line[z].alpha || 99),
											from : c.trendlines[x].line[z].startvalue ? c.trendlines[x].line[z].startvalue
													: 0,
							...
							g.yAxis[0].plotLines
									.push( {
										color : convertColor(
												c.trendlines[x].line[z].color || '333333',
												c.trendlines[x].line[z].alpha || 99),
										value : c.trendlines[x].line[z].startvalue ? c.trendlines[x].line[z].startvalue
												: 0,
										width : c.trendlines[x].line[z].thickness ? c.trendlines[x].line[z].thickness
												: 1
									})
						}
					}
						...
						for (z = 0; z < c.vtrendlines[x].line.length; z += 1) {
							if (c.vtrendlines[x].line[z].istrendzone !== '0') {
								g.xAxis.plotBands
										.push( {
											color : convertColor(
													c.vtrendlines[x].line[z].color || '333333',
													c.vtrendlines[x].line[z].alpha || 99),
											from : c.vtrendlines[x].line[z].startvalue ? c.vtrendlines[x].line[z].startvalue
													: 0,
							...
							g.xAxis.plotLines
									.push( {
										color : convertColor(
												c.vtrendlines[x].line[z].color || '333333',
												c.vtrendlines[x].line[z].alpha || 99),
										value : c.vtrendlines[x].line[z].startvalue ? c.vtrendlines[x].line[z].startvalue
												: 0,
										width : c.vtrendlines[x].line[z].thickness ? c.vtrendlines[x].line[z].thickness
												: 1
									})
						}
					}
			...
			g.exporting.buttons.exportButton.enabled = c.chart.exportshowmenuitem == '0' ? false
					: true;
			g.exporting.filename = c.chart.exportfilename ? c.chart.exportfilename
					: 'FusionCharts';
			g.exporting.width = e;
			...
			g.chart.borderWidth = c.chart.showborder == '0' ? 0
			...
			g.chart.plotBorderColor = convertColor(
					c.chart.canvasbordercolor || '545454',
					c.chart.canvasborderalpha || 100);
			g.chart.plotBorderWidth = c.chart.canvasborderthickness ? c.chart.canvasborderthickness
					: 2;
			g.plotOptions.series.borderColor = convertColor(
					c.chart.plotbordercolor || '333333',
					c.chart.plotborderalpha || 95);
			g.plotOptions.series.borderWidth = c.chart.showplotborder == '0' ? 0
					: (c.chart.plotborderthickness ? c.chart.plotborderthickness
							: 1);
			g.plotOptions.series.borderRadius = c.chart.useroundedges == '1' ? 5
					: 0;
			...
			g.chart.plotBackgroundColor = (s(b) == 'pie') ? 'rgba(255,255,255,0)'
					: (r(
							h,
							plotY,
							e - (g.chart.margin[1] + g.chart.margin[3]),
							(f ? f : 400)
									- (g.chart.margin[0] + g.chart.margin[2]),
							c.chart.canvasbgangle !== undefined ? c.chart.canvasbgangle
									: 0,
							c.chart.canvasbgcolor ? c.chart.canvasbgcolor
									: "FFFFFF",
							c.chart.canvasbgalpha ? c.chart.canvasbgalpha
									: "100",
							c.chart.canvasbgratio ? c.chart.canvasbgratio : ""));
			return g
		}
		FCC.dataFormat = 'json';
...
(function() {
	...
	f.addEventListener('LinkedChartInvoked', function(a, b) {
		var c = a.sender, param = c.clone( {
			dataSource : b.data,
			dataFormat : b.linkType === 'URL' ? FusionChartsDataFormats.XMLURL
					: b.linkType,
