...
if (typeof FusionCharts === 'undefined') {
	alert(
			'FusionChartsExport: object::FusionCharts was not found.' + ' Verify script inclusions.',
			10901271400);
...
try {
	if (typeof _FCEO.__global === 'undefined') {
		_FCEO.playerVersion = infosoftglobal.FusionChartsUtil
				.getPlayerVersion()
	} else {
	...
	_FCEO.trace(
			'FusionChartsExport: object::Flash Player DetectionError.\n' + err,
			10902182119)
}
...
_FCEO.probeHandler = function(a) {
	...
	return _FCEO.L.isString(a) ? a : (a.parameters != null && _FCEO.L
			.isString(a.parameters.exportHandler)) ? a.parameters.exportHandler
			: null
};
...
_FCEO.updateComponent = function(b) {
	...
	_FCEO.L.sync(b.componentAttributes, b.srcObj.variables
			|| b.srcObj.flashVars);
	var c;
	var d = function(a) {
		return !_FCEO.L.isObj((b.srcObj.variables || b.srcObj.flashVars)[a],
				'undefined') ? (b.srcObj.variables || b.srcObj.flashVars)[a]
				: _FCEO.defaultParameters.componentAttributes[a]
	};
	try {
...
_FCEO.batchExport = function(b, c) {
	...
	var e = parseInt(b.componentAttributes.strictTrigger || 0) == 0 ? function(
			a) {
		return a
	} : function(a) {
		a.handlerId = b.id;
